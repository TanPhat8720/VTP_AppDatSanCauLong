...
import 'package:vtp_appcaulong/screens/search_result_screen.dart';
import 'package:vtp_appcaulong/validator.dart';
import 'package:vtp_appcaulong/widgets/custom_time_picker.dart';
...
class _HomeScreenState extends State<HomeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final dialog = Obx(() => branchController.isLoading.isTrue
        ? Center(
    ...
    return Scaffold(
      body: Obx(
        () => branchController.isLoading.isTrue
            ? Center(
                child: CircularProgressIndicator(),
              )
            : RefreshIndicator(
                ...
                child: ListView(
                  children: [
                    Padding(
                      padding:
                          const EdgeInsets.symmetric(horizontal: largePadding),
                      child: Container(
