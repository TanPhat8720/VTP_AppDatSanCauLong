...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  _TappableLabel _buildTappableLabel(TextTheme textTheme, Color color,
    ...
    final TextStyle style = textTheme.bodyMedium!.copyWith(color: color);
...
class IntervalTimePickerDialog extends StatefulWidget {
  ...
  @override
  State<IntervalTimePickerDialog> createState() =>
      _IntervalTimePickerDialogState();
}
...
class _IntervalTimePickerDialogState extends State<IntervalTimePickerDialog>
    with RestorationMixin {
